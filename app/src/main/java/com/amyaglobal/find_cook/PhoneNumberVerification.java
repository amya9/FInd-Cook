    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, post_url, new Response.Listener<String>() {
                ...
                verifyOtp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (enterOtp.getText().toString().equals(String.valueOf(otp_number))){
                            ...
                            Toast.makeText(PhoneNumberVerification.this, "Your order has been placed successfully", Toast.LENGTH_SHORT).show();
                            finish();
                            AddNewCook.isPhoneNumberVerified = true;
                        }
                        else{
                            Toast.makeText(PhoneNumberVerification.this, "Incorrect OTP!!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PhoneNumberVerification.this, "Failed to send the OTP code", Toast.LENGTH_SHORT).show();
                finish();
            }
        }){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PhoneNumberVerification.this);
